...
class Sdata_generator:
    ...
    def __call__(self, C, aug=True):
        ...
        for i in tqdm(range(len(self.data))):
            ...
            if aug is True:
                data = aug_tools.aug_look('subtract')(p)
                X_1.append(data)
                X_2.append(data)
                X_3.append(data)
                Y.append(label)
                data = aug_tools.aug_look('randomFlip')(p)
                X_1.append(data)
                X_2.append(data)
                X_3.append(data)
                Y.append(label)
                data = aug_tools.aug_look('zeroOutAxis')(p)
                X_1.append(data)
                X_2.append(data)
                X_3.append(data)
                Y.append(label)
                data = aug_tools.aug_look('rotate')(p)
                X_1.append(data)
                X_2.append(data)
                X_3.append(data)
                Y.append(label)
                data = aug_tools.aug_look('zeroOutJoints')(p)
                X_1.append(data)
                X_2.append(data)
                X_3.append(data)
                Y.append(label)
                data = aug_tools.aug_look('gausNoise')(p)
                X_1.append(data)
                X_2.append(data)
                X_3.append(data)
                Y.append(label)
                data = aug_tools.aug_look('gausFilter')(p)
                X_1.append(data)
                X_2.append(data)
                X_3.append(data)
                Y.append(label)
                data = aug_tools.aug_look('shear')(p)
                X_1.append(data)
                X_2.append(data)
                X_3.append(data)
                Y.append(label)
